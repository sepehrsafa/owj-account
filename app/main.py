...
from app.routes import (auth_router, business_router, user_group_router,
                        user_router, wallet_router, ipg_router, wallet_transactions_router)
from fastapi import FastAPI
from fastapi.exceptions import RequestValidationError
from starlette.exceptions import HTTPException as StarletteHTTPException
from tortoise.contrib.fastapi import register_tortoise

from owjcommon.exceptions import (OWJException, http_exception_handler,
...
app.include_router(wallet_transactions_router, prefix=BASE_PREFIX + "/wallet/transaction")
